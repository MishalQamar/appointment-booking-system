...
export function ServiceCard({ service, href }: ServiceProps) {
  return (
    ...
    >
      ...
      <div className="bg-orange-500 text-white px-3 py-1 rounded-full font-bold text-sm mb-2">
      ...
      <div className="mt-3">
        ...
        <button className="bg-orange-500 text-white px-4 py-1 rounded-full text-xs font-bold hover:bg-orange-600 transition-colors">
          BOOK NOW
        </button>
      </div>
    </Link>
